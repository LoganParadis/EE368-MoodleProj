...
$string['configforcelogin'] = 'Normally, the site home and the course listings cannot be read by people without logging in to the site. If you do not want to force people to log in before they do ANYTHING on the site, then you should disable this setting.';
