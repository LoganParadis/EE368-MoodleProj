...
/**
 * Upload a file CVS file with bulkuser information.
 *
 * @package    tool_bulkenrol
...
class tool_bulkenrol_step1_form extends tool_bulkenrol_base_form {
    ...
    public function definition () {
        ...
        $mform->addElement('filepicker', 'bulkuserfile', get_string('bulkuserfile', 'tool_bulkenrol'));
        $mform->addRule('bulkuserfile', null, 'required');
        $mform->addHelpButton('bulkuserfile', 'bulkuserfile', 'tool_bulkenrol');
